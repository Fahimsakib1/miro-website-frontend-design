...
const Header = () => {
    ...
    return (
        <div>
            <div className={`${isMenuOpen ? '' : 'bg-white shadow-xl'}  px-4 py-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen md:px-10 lg:px-8`}>
                <div className="relative flex items-center justify-between ">
                    <div className=" flex justify-center items-center">
                        ...
                        <ul className="flex items-center hidden space-x-6 lg:flex">
                            ...
                            <div className="dropdown dropdown-end">
                                ...
                                >
                                    <div className=" flex justify-center items-center " title='More Items'>
                    ...
                    <ul className="flex items-center hidden space-x-5 lg:flex">
                        ...
                        <div className="inline-flex items-center justify-center h-[50px] px-5 font-medium text-white transition duration-200 rounded-full  bg-[#4262FF] hover:bg-blue-700 cursor-pointer">
                                    ...
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <div>
                                            <button
                                                ...
                                                title="Close Menu"
                                                className="p-2 bg-red-600 rounded-full -mt-2 mr-4 transition duration-200  focus:outline-none focus:shadow-outline"
