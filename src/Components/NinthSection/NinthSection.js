                ...
                <div className='mt-10 grid lg:grid-cols-7 md:grid-cols-3 grid-cols-2 mx-auto md:gap-x-8 gap-x-6 md:gap-y-8 gap-y-6'>
                    {
                        details.map((course, index) => (
                            <button
                                key={index}
                                className={`${selectedCourseIndex === index ? 'bg-[#F2F2F2]' : 'hover:bg-sky-100 border-2 border-gray-100'} text-black rounded-full  py-[11px] text-[12px] font-semibold`}
                    ...
                    <div className=" md:px-4 px-2 mt-12 grid gap-0 lg:grid-cols-2">
                        <div className="flex flex-col md:pr-8 xl:pr-0 lg:max-w-sm">
                            ...
                            <div className='mt-[50px] '>
                                ...
                                >
                                    <img
                                        className="lg:mt-0 md:mt-3 mt-5  w-[27px] h-[27px] hover:scale-110 hover:ease-in duration-300 delay-150 cursor-pointer "
